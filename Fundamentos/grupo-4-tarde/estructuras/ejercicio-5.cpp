...
void llenarContacto(Contacto contactos[], int cantidadContactos) {
...
int buscarContacto(Contacto contactos[], int cantidad, string nombreBuscado) {
...
int main() {
    ...
    llenarContacto(contactos, cantidadContactos);
